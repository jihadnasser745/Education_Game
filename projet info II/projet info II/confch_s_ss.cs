...
{
    public partial class confch_s_ss : Form
    {
        int i;
        int[] t = new int[10];
        ...
        private void confch_s_ss_Load(object sender, EventArgs e)
        {
            ...
            DataRow[] dr = xml.xmlsearch("[ID] = '" + i.ToString() + "'", "confchsss.xml");
            ...
            pictureBox1.ImageLocation = (@"C:\Users\User\Desktop\projet info II\projet info II\bin\Debug\pictures\picconfchsss\" + s);
            suivant.Visible = false;
        }
        private void reponce1_Click(object sender, EventArgs e)
        {
            DialogResult dialog = MessageBox.Show("Est ce que tu es sure??", "Confchsss", MessageBoxButtons.YesNo);
