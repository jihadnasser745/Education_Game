...
{
    public partial class confvf : Form
    {
        int i;
        int[] t = new int[10];
        ...
        private void confvf_Load(object sender, EventArgs e)
        {
            ...
            DataRow[] dr = xml.xmlsearch("[ID] = '" + i.ToString() + "'", "confvf.xml");
            ...
            pictureBox1.ImageLocation = (@"C:\Users\User\Desktop\projet info II\projet info II\bin\Debug\pictures\picconfvf\" + s);
...
reponce1.Visible = true;
        ...
        {
            DialogResult dialog = MessageBox.Show("Est ce que tu es sure??", "Confvf", MessageBoxButtons.YesNo);
