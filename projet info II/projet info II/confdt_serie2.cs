...
{
    public partial class confdt_serie2 : Form
    {
        int i;
        int[] t = new int[10];
        private SoundPlayer _sound0, _sound1, _sound2;
        public confdt_serie2()
        {
            InitializeComponent();
 ...
 reponce1.Visible = true;
            ...
            _sound2.Stop();
            i = t[j];
            DataRow[] dr = xml.xmlsearch("[ID] = '" + i.ToString() + "'", "confdt_serie2.xml");
            ...
            pictureBox1.ImageLocation = (@"C:\Users\User\Desktop\projet info II\projet info II\bin\Debug\pictures\picconfdtserie2\" + s);
        ...
        {
            DialogResult dialog = MessageBox.Show("Est ce que tu es sure??", "Confdt_serie2", MessageBoxButtons.YesNo);
        ...
        private void confdt_serie2_Load(object sender, EventArgs e)
        {
