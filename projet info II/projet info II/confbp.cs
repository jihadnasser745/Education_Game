...
{
    public partial class confbp : Form
    {
        int i;
        int[] t = new int[10];
        ...
        private void confbp_Load(object sender, EventArgs e)
        {
            ...
            DataRow[] dr = xml.xmlsearch("[ID] = '" + i.ToString() + "'", "confbp.xml");
            ...
            pictureBox1.ImageLocation = (@"C:\Users\User\Desktop\projet info II\projet info II\bin\Debug\pictures\picconfbp\" + s);
        ...
        {
            DialogResult dialog = MessageBox.Show("Est ce que tu es sure??", "Confbp", MessageBoxButtons.YesNo);
