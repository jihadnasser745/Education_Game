...
{
    public partial class confgch : Form
    {
        int i;
        int[] t = new int[10];
        ...
        private void confjch_Load(object sender, EventArgs e)
        {
            ...
            DataRow[] dr = xml.xmlsearch("[ID] = '" + i.ToString() + "'", "confgch.xml");
            ...
            pictureBox1.ImageLocation = (@"C:\Users\User\Desktop\projet info II\projet info II\bin\Debug\pictures\picconfgch\" + s);
...
reponce1.Visible = true;
        ...
        {
            DialogResult dialog = MessageBox.Show("Est ce que tu es sure??", "Confgch", MessageBoxButtons.YesNo);
